...
/datum/job/bartender
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/bartender/red(H), slot_w_uniform)
		...
		if(H.backbag == 1)
			...
			H.equip_to_slot_or_del(new /obj/item/ammo_casing/shotgun/beanbag(H), slot_in_backpack)
			H.equip_to_slot_or_del(new /obj/item/ammo_casing/shotgun/beanbag(H), slot_in_backpack)
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/wallet/random(H), slot_in_backpack)
...
/datum/job/lawyer
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/brown(H), slot_shoes)
		//H.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses/big(H), slot_in_backpack)
		...
		if(H.backbag == 1)
			...
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/box/survival(H.back), slot_in_backpack)
		if(H.mind.role_alt_title && H.mind.role_alt_title == "Internal Affairs Agent")
