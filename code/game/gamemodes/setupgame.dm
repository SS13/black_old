...
/proc/setupcorpses()
	for (var/obj/effect/landmark/A in landmarks_list)
		...
		if (A.name == "Corpse-Engineer")
			...
			M.real_name = "Corpse"
			M.death()
			if (!M.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_eng(M), slot_l_ear))
				M.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_eng(M), slot_r_ear)
		...
		if (A.name == "Corpse-Syndicate")
			...
			M.real_name = "Corpse"
			M.death()
			if (!M.equip_to_slot_or_del(new /obj/item/device/radio/headset(M), slot_l_ear))
				M.equip_to_slot_or_del(new /obj/item/device/radio/headset(M), slot_r_ear)
