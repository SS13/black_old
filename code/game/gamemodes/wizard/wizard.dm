...
/datum/game_mode/proc/equip_wizard(mob/living/carbon/human/wizard_mob)
	...
	if (!wizard_mob.equip_to_slot_or_del(new /obj/item/device/radio/headset(wizard_mob), slot_l_ear))
		wizard_mob.equip_to_slot_or_del(new /obj/item/device/radio/headset(wizard_mob), slot_r_ear)
