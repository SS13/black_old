...
datum/objective/steal
	...
	var/global/possible_items[] = list(
		...
		"golden wrestling championship belt" = /obj/item/weapon/storage/belt/champion,
		"a nasa voidsuit" = /obj/item/clothing/suit/space/nasavoid,
		"monitor decription key note" = /obj/item/weapon/paper/monitorkey ,
		"28 moles of plasma (full tank)" = /obj/item/weapon/tank,
		"a sample of slime extract" = /obj/item/slime_extract,
		"a piece of corgi meat" = /obj/item/weapon/reagent_containers/food/snacks/meat/corgi,
		//"a piece of pug meat" = /obj/item/weapon/reagent_containers/food/snacks/meat/pug,
