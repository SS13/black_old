...
/area/Entered(A)
	...
	if(prob(35))
		...
		if(istype(src, /area/chapel))
			...
			sound = pick('sound/ambience/ambispace.ogg',/*'sound/music/title2.ogg',*/ 'sound/music/space.ogg','sound/ambience/crabnebula.ogg','sound/music/main.ogg','sound/music/traitor.ogg','sound/ambience/spacey.ogg','sound/ambience/spacey1.ogg','sound/ambience/spacey2.ogg','sound/ambience/spacey3.ogg')
			...
			sound = pick('sound/ambience/ambimine.ogg', 'sound/ambience/song_game.ogg', 'sound/ambience/creepy.ogg', 'sound/ambience/inthedark.ogg')
			musVolume = 25
			...
			sound = pick('sound/ambience/ambisin2.ogg', 'sound/ambience/signal.ogg', 'sound/ambience/signal.ogg', 'sound/ambience/ambigen10.ogg', 'sound/effects/computerbeeps.ogg')
		else
