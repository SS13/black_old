...
/obj/item/weapon/bluespace_crystal/attack_self(var/mob/user)
	blink_mob(user)
	user.drop_item()
	user.visible_message("<span class='notice'>[user] crushes the [src]!</span>")
	del(src)

/obj/item/weapon/bluespace_crystal/proc/blink_mob(var/mob/living/L)
...
/obj/item/weapon/bluespace_crystal/artificial
	...
	origin_tech = "bluespace=2;materials=2"
