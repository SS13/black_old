...
/mob/living/verb/ghost()
	...
	if(stat == DEAD)
		...
		var/response = alert(src, "Are you -sure- you want to ghost?\n(You are alive. If you ghost, you won't be able to play this round for another [timetorespawn] minutes! You can't change your mind so choose wisely!)","Are you sure you want to ghost?","Ghost","Stay in body")
...
/mob/dead/observer/verb/boo()
	set category = "Ghost"
	set name = "Boo!"
	set desc= "Scare your crew members because of boredom! Spoooky!"
...
/mob/dead/observer/verb/colorchange()
	...
	switch(icontype)
		...
		if("Blue") icon_state = "ghost_blue"
		if("Yellow") icon_state = "ghost_yellow"
		if("Green") icon_state = "ghost_green"
		if("Pink") icon_state = "ghost_pink"
		if("Cyan") icon_state = "ghost_cyan"
		if("Dark Blue") icon_state = "ghost_dblue"
