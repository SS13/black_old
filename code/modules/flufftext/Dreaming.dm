mob/living/carbon/proc/dream()
	...
	var/list/dreams = list(
		...
		"a black man is laughing","monkeys are dancing","space carp","a burger","an assistant","time travellers","The Monkey Island",
		"abandoned station","sunny shores","clouds","a security officer is dancing","your mom","big black cigar","a sword slashing apples in half",
		"arrival shuttle","empty brig","soghuns dueling","dionea","a cave","an old man fishing","that one barsign","something in the dark",
		"HoS's wife","a mime","a clown","Nikolai McRoy","a phoenix","Martians","green goo","shores of Kerbin","Omicron-7","Tau Ceti",
		"a chase","a hike","an expedition","a mankini","spiders","bugs","captain taking shower","yourself","an electric sheep","Pun Pun",
