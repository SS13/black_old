...
datum/design/atmoscontrol
	name = "Circuit Design (Central Atmospherics Computer)"
	desc = "Allows for the construction of circuit boards used to build a Central Atmospherics Computer."
	id = "atmoscontrol"
	req_tech = list("programming" = 4, "engineering" = 3) //Seems high enough to keep the chucklefucks at bay
	build_type = IMPRINTER
	materials = list("$glass" = 4500, "$gold" = 500, "sacid" = 20)
