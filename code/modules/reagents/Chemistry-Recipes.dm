...
////DRINKS THAT REQUIRED IMPROVED SPRITES BELOW:: -Agouri/////
		...
		milkshake_banana
			...
			required_reagents = list("milkshake" = 2, "banana" = 1)
			result_amount = 4
		...
		milkshake_berry
			...
			required_reagents = list("milkshake" = 2, "berryjuice" = 1)
			result_amount = 4
		...
		milkshake_coffee
			...
			required_reagents = list("milkshake" = 2, "coffee" = 1)
			result_amount = 4
		...
		milkshake_tomato
			...
			required_reagents = list("milkshake" = 2, "tomatojuice" = 1)
			result_amount = 4
