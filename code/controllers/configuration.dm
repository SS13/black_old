/datum/configuration
	...
	var/vote_period = 1200				// length of voting period (deciseconds, default 1 minute)
...
//	var/enable_authentication = 0		// goon authentication
	...
	var/admin_legacy_system = 1	//Defines whether the server uses the legacy admin system with admins.txt or the SQL system.
